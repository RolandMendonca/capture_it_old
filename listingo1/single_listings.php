                            ...
                            <div class="single_explorer">
                                ...
                                <div class="explorer_bottom d-flex">
                                    ...
                                    <div class="explorer_info">
                                        ...
                                        <p>700/D, Kings road, Green lane, Mundkur</p>
                                        <ul>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="single_explorer">
                                ...
                                <div class="explorer_bottom d-flex">
                                    ...
                                    <div class="explorer_info">
                                        <h3><a href="#">Shreyank</a></h3>
                                        <p>700/D, Kings road, Green lane, Katpadi</p>
                                        <ul>
                                            <li> <i class="fa fa-phone"></i>
                                                +10 278 367 9823</li>
                                            <li><i class="fa fa-envelope"></i> contact@midnight.com</li>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="single_explorer">
                                ...
                                <div class="explorer_bottom d-flex">
                                    ...
                                    <div class="explorer_info">
                                        <h3><a href="#">Afthab</a></h3>
                                        <p>700/D, Kings road, Green lane, Kapu</p>
                                        <ul>
                                            <li> <i class="fa fa-phone"></i>
                                                +10 278 787 9823</li>
                                            <li><i class="fa fa-envelope"></i> contact@midnight.com</li>
